...
private fun FixedExpensesContent(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.fixed_expenses_title), fontWeight = FontWeight.Bold) },
                navigationIcon = {
    ...
    NetWorthTheme {
        FixedExpensesContent(
            uiState = FixedExpensesUiState(
                ...
                expenses = listOf(
                    FixedExpenseUiModel(1, "Rent", "Monthly", "€1,200.00 / mo", 1200.0, null, com.agcoding.networkapp.fixedexpenses.domain.model.RecurrenceType.MONTHLY, null),
                    FixedExpenseUiModel(2, "Netflix", "Subscription", "€15.99 / mo", 15.99, "1 Jun 2025", com.agcoding.networkapp.fixedexpenses.domain.model.RecurrenceType.MONTHLY, null),
                    FixedExpenseUiModel(3, "Car Insurance", "Annual", "€600.00 / yr", 600.0, "1 Jan 2026", com.agcoding.networkapp.fixedexpenses.domain.model.RecurrenceType.ANNUAL, "€50.00 / mo"),
                ),
            ),
            onIntent = {},
            onNavigateBack = {},
